    ...
    <section className="py-12 md:py-24" id="apartments">
      <div className="container">
        <div className="w-full ">
          <h2 className="text-3xl font-bold tracking-tighter md:text-5xl lg:text-5xl/none text-golden max-w-[600px] mb-[60px]">
            Наши квартиры
          </h2>
        </div>
