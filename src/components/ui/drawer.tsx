...
interface BurgerMenuIconProps extends ButtonHTMLAttributes<HTMLButtonElement> { }
  ...
  return (
    <DrawerPortal>
      ...
      <DrawerPrimitive.Content
        ref={ref}
        className={cn(
          "fixed  z-50  flex h-auto flex-col  bg-siteBackground",
...
export {
  ...
  DrawerTitle,
  DrawerDescription,
  BurgerMenuIcon // Export the BurgerMenuIcon
};
