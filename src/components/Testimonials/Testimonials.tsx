...
export function Testimonials() {
    ...
    return (
        <section id='testimonials'>
            <div className="relative flex h-[500px] w-full flex-col items-center justify-center overflow-x-clip rounded-lg bg-siteBackground">
                ...
                <div className="pointer-events-none absolute inset-y-0 left-0 w-1/2 bg-gradient-to-r from-siteBackground dark:from-siteBackground"></div>
                <div className="pointer-events-none absolute inset-y-0 right-0 w-1/2 bg-gradient-to-l from-siteBackground dark:from-siteBackground"></div>
