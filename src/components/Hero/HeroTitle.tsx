    ...
    return (
        <div className="container flex justify-center  pt-[180px]">
            <div className="w-[556px]  flex  items-center flex-col gap-5 text-center  ">
                <WordPullUp words=' Жилой комплекс в историческом центре' className=" text-[38px] md:text-[48px] md:leading-[64px] lg:text-[64px] text-center font-bold lg:leading-[64px] lg:tracking-tight mb-[30px] text-golden">
